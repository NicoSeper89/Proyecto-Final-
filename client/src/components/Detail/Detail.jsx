...
export default function Detail(props) {
  ...
  return (
    <>
      ...
      <Flex w={"100%"} flexDirection={"column"} alignItems={"center"} justifyContent={"flex-start"} p={".5rem"} position="relative" >
        {Object.entries(miStateDetail).length > 0 ? (
          <Flex p={"1rem"} w={"100%"} alignItems={"flex-start"} justifyContent={"flex-start"} >
            <Flex flexDirection={"column"} gap={".7rem"} alignItems={"flex-start"} justifyContent={"space-between"} p={"0rem .8rem"} position={"relative"}>
              <Image borderRadius={"12px"} w={"50rem"} src={miStateDetail.property.propertyImages[0] ? miStateDetail.property.propertyImages[0].url : imgNotAvailable} />
              <Flex position={"relative"} justifyContent={"flex-start"} gap={"1rem"} alignItems={"center"} w={"50rem"}>
                {miStateDetail.property.propertyImages?.map((e, i) => ((i !== 0) ? <Box w={"10rem"}>
                  <Image borderRadius={".2rem"}
                    key={i}
                    src={e.url} /></Box> : null))}
              </Flex>
            </Flex>

            <Flex w={"100%"} gap={"1rem"} justifyContent="flex-start" flexDirection={"column"} alignItems={"center"}>
              ...
              <Flex w={"100%"} justifyContent="flex-start" flexDirection={"column"} alignItems={"center"}>
                
                <Box borderRadius={"0.5rem 0.5rem 0rem 0rem"} width={"90%"} p={".3rem 0rem"} textAlign={"center"} bg={"facebook.300"}><Heading color={"white"}>Descripción</Heading></Box>
                
                <Box borderRadius={"0rem 0rem 0.5rem 0.5rem"} flexDirection={"column"} gap={".5rem"} color={"gray.600"} width={"90%"} display={"flex"} p={"1rem"} borderWidth="1px" borderColor="gray.200" >
              ...
              <Flex w={"100%"} justifyContent="flex-start" flexDirection={"column"} alignItems={"center"}>
                <Box borderRadius={"0.5rem 0.5rem 0rem 0rem"} width={"90%"} p={".3rem 0rem"} textAlign={"center"} bg={"facebook.300"}><Heading color={"white"}>Detalles</Heading></Box>
                ...
                <Box borderRadius={"0rem 0rem 0.5rem 0.5rem"} flexDirection={"column"} gap={".5rem"} color={"gray.600"} width={"90%"} display={"flex"} p={"1rem"} borderWidth="1px" borderColor="gray.200" >
                  ...
                  {miStateDetail.property.services.map((e) => <Flex alignItems={"center"} gap={".4rem"} ><FontAwesomeIcon icon={faCheck} /> <Text>{e.name}</Text></Flex>)}
