      ...
      <form action="" className={style.continer}>
        <Box className={style.input}>
          ...
          <FormControl isInvalid={isError}>
            ...
            {isError ? (
              <FormErrorMessage>Su Usuario debe tener minimo 4 caracteres</FormErrorMessage>
            ) : null}
          </FormControl>
        </Box>
        <Box className={style.input}>
          ...
          <FormControl size="md" isInvalid={isError2}>
            ...
            {isError2 ? (
              <FormErrorMessage>Su password debe tener minimo 5 Caracteres</FormErrorMessage>
            ) : null}
          </FormControl>
        </Box>
